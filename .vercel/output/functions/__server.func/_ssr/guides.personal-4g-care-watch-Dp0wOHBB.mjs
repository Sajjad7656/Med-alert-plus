...
import { m as ArrowLeft, S as ShieldCheck, o as Watch, W as Wifi, H as Heart, P as Phone } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-4xl px-4 py-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row gap-8 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl font-bold text-navy md:text-5xl mb-4", children: "Personal 4G Care Watch" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground leading-relaxed", children: "Complete setup instructions for your all-in-one smart medical alert watch with GPS, heart rate monitoring, and SOS features." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full md:w-1/3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: watch, alt: "Personal 4G Care Watch", className: "w-full rounded-2xl shadow-xl" }) })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 md:grid-cols-2", children: [{
        ...
        desc: "Power on and activate your 4G Care Watch for the first time.",
        steps: ["Charge for 2 hours", "Press and hold side button", "Wait for MediAlert+ logo", "Complete initial setup"]
      }, {
        icon: Wifi,
        title: "4G Network Setup",
        desc: "Connect to our nationwide 4G LTE network for coverage anywhere.",
        steps: ["Network auto-connects", "Verify signal strength", "Test emergency calling", "Confirm GPS lock"]
      }, {
        icon: Heart,
        title: "Health Monitoring",
        desc: "Set up heart rate monitoring and health tracking features.",
        steps: ["Enable heart rate monitoring", "Set alert thresholds", "Configure wellness checks", "Test fall detection"]
      }, {
        icon: Phone,
        title: "Emergency Testing",
        desc: "Test all emergency features to ensure proper operation.",
        steps: ["Test SOS button", "Verify two-way calling", "Test GPS location", "Complete monitoring test"]
