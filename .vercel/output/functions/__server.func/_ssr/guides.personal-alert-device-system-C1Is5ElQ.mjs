...
import { m as ArrowLeft, S as ShieldCheck, n as Smartphone, W as Wifi, M as MapPin, U as Users } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row gap-8 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl font-bold text-navy md:text-5xl mb-4", children: "Personal Alert Device System" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground leading-relaxed", children: "Complete setup instructions for your SmartGo 4G mobile device with nationwide coverage and GPS tracking." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full md:w-1/3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: mobile, alt: "Personal Alert Device", className: "w-full rounded-2xl shadow-xl" }) })
      ] })
    ] }),
